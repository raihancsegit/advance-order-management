...
class AORW_API
{
    ...
    public function register_routes()
    {
        ...
        // ✅ New route for customer's monthly spending chart
        register_rest_route($namespace, '/customer/spending-chart', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array($this, 'get_customer_spending_chart_data'),
            'permission_callback' => array($this, 'is_current_customer_allowed'),
        ));

        // ✅ New route for exporting customer's orders
        register_rest_route($namespace, '/customer/export-orders', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array($this, 'export_customer_orders'),
            'permission_callback' => array($this, 'is_current_customer_allowed'),
        ));

        // ✅ New route for customer's paginated order list
        register_rest_route($namespace, '/customer/orders', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array($this, 'get_customer_orders_list'),
            'permission_callback' => array($this, 'is_current_customer_allowed'),
            'args'                => array(
